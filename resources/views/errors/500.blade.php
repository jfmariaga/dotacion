...
<head>
	...
	<title>Error de escritura</title>
	...
	<div id="notfound">
		<div class="notfound">
			<div>
				...
				<h2 style="color: #fff">Error<br>500</h2>
			</div>
			<p style="color: #fff">Solo se permite la lectura de la tarjeta RFID<a href="{{route('entrega') }}">Regresar</a></p>
		</div>
	</div>
