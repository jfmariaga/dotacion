<div>
    <div class="modal-body">
        <div class="row">
            ...
            {{-- <fieldset class="form-group floating-label-form-group col-lg-6 col-12">
                <label>Cargo</label>
                <input type="text" class="form-control  @error('cargo') border_error @enderror" placeholder="Cargo"
                    wire:model="cargo">
                @error('cargo')
                    <span class="input_error error text-danger">{{ $message }}</span>
                @enderror
            ...
            <fieldset class="form-group floating-label-form-group col-lg-6 col-12">
                ...
                <input type="text" class="form-control @error('password') border_error @enderror"
            ...
            <fieldset class="form-group floating-label-form-group col-lg-6 col-12">
                <label>Estado</label>
                <select wire:model.defer="estado" @error('estado') border_error @enderror class="form-control">
                    <option selected>Seleccionar...</option>
            ...
            <fieldset class="form-group floating-label-form-group col-lg-6 col-12">
                ...
                <input type="number" class="form-control @error('caja') border_error @enderror" placeholder="Numero de caja de dotación"
                    wire:model="caja">
                @error('caja')
                    <span class="input_error error text-danger">{{ $message }}</span>
                @enderror
